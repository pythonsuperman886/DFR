...
class Extractor(nn.Module):
    ...
    def __init__(self, backbone='vgg19',
        ...
        self.replicationpad = nn.ReflectionPad2d((padding_w, padding_w, padding_h, padding_h))
    ...
    def forward(self, input):
        ...
        for _, feat_map in feat_maps.items():
            ...
            # if False:
                # print("-"*30)
                # print("i: ",i)
                # print("feat_map1 size: ",feat_map.shape)
                # i=i+1
                # with aggregations
                # resizing
        ...
        # print("feaure shpae: ",features.shape)
